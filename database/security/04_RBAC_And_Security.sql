/*==============================================================================
  EV_Charging_System - RBAC & SECURITY ARCHITECTURE
  ==============================================================================
...
IF NOT EXISTS (SELECT 1 FROM sys.sql_logins WHERE name = N'ev2_admin_login')
    CREATE LOGIN ev2_admin_login WITH PASSWORD = N'Admin@2026!Secure#EV',
        DEFAULT_DATABASE = EV_Charging_System,
        CHECK_EXPIRATION = ON,
        CHECK_POLICY = ON;
GO
...
GRANT VIEW DEFINITION ON DATABASE :: [EV_Charging_System] TO db_role_admin;
GO
...
/*
  ...
  1. TDE (Transparent Data Encryption) - Encrypts data at rest
     ...
     ALTER DATABASE EV_Charging_System SET ENCRYPTION ON;
