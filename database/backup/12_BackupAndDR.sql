/*==============================================================================
  EV_Charging_System - BACKUP & DISASTER RECOVERY STRATEGY
  ==============================================================================
...
DECLARE @BackupPath NVARCHAR(500) = @BackupRoot + N'EV_Charging_System\';
PRINT N'Recommended backup folder: ' + @BackupPath;
PRINT N'Create the backup directories manually before enabling live backups.';
GO
...
CREATE OR ALTER PROCEDURE Infrastructure.sp_CleanupOldBackups
    ...
    @BackupPath          NVARCHAR(500) = N'C:\Backup\EV_Charging_System\'
AS
BEGIN
    SET NOCOUNT ON;
...
FROM DISK = N'C:\Backup\EV_Charging_System\EV_Charging_System_Full_current.bak'
WITH
    FILE = 1,
    NORECOVERY,
    REPLACE,
...
RESTORE DATABASE EV_Charging_System
FROM DISK = N'C:\Backup\EV_Charging_System\EV_Charging_System_Diff_current.bak'
WITH
    FILE = 1,
    NORECOVERY,
    STATS = 10;
...
FROM DISK = N'C:\Backup\EV_Charging_System\Logs\EV_Charging_System_Log_20250407_140000.trn'
WITH
    FILE = 1,
    NORECOVERY,
...
/*
  ...
  WHERE database_name = 'EV_Charging_System'
...
CREATE MASTER KEY ENCRYPTION BY PASSWORD = N'EV_Charging_System_MasterKey_2026!';
GO
...
TO DISK = N'C:\Backup\EV_Charging_System\EV_Charging_System_Encrypted.bak'
WITH
