/*==============================================================================
  EV_Charging_System_Validation - SEED DATA
  =============================================================================*/
...
INSERT INTO Users.UserProfile (UserID, FullName)
SELECT UserID, N'Nguyá»…n Thá»‹ Mai'    FROM Users.[User] WHERE Username = N'nguyenthimai' UNION ALL
...
WHERE u.Username IN (N'nguyenthimai', N'tranvannam', N'lethihuong', N'phamvantuan', N'hoangminhtam', N'dothanhson', N'vuthilan', N'ngovanhai')
...
SELECT NULL, d.Day, CAST(h.Start AS TIME), CAST(h.End AS TIME), 1, 1.50
FROM (VALUES (1),(2),(3),(4),(5)) d(Day)
CROSS JOIN (VALUES ('17:00','19:00')) h(Start, End)
UNION ALL
