/*==============================================================================
  EV_Charging_System_Validation - ENTERPRISE DATABASE CREATION
  ==============================================================================
...
-- =============================================================================
IF DB_ID(N'EV_Charging_System_Validation') IS NOT NULL
BEGIN
    ALTER DATABASE EV_Charging_System_Validation SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
    DROP DATABASE EV_Charging_System_Validation;
END
GO
...
CREATE DATABASE EV_Charging_System_Validation
...
ALTER DATABASE EV_Charging_System_Validation SET AUTO_CREATE_STATISTICS ON;
ALTER DATABASE EV_Charging_System_Validation SET AUTO_UPDATE_STATISTICS ON;
ALTER DATABASE EV_Charging_System_Validation SET AUTO_UPDATE_STATISTICS_ASYNC ON;
ALTER DATABASE EV_Charging_System_Validation SET PAGE_VERIFY CHECKSUM;
ALTER DATABASE EV_Charging_System_Validation SET READ_COMMITTED_SNAPSHOT ON;
ALTER DATABASE EV_Charging_System_Validation SET ALLOW_SNAPSHOT_ISOLATION ON;
ALTER DATABASE EV_Charging_System_Validation SET DELAYED_DURABILITY = DISABLED;
GO
...
PRINT N'Database EV_Charging_System_Validation created with 9 domain schemas.';
GO
